...
function updateTimer() {
    const targetDate = new Date("September 26, 2026 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543814641607'; // Número para el primer botón
    const recipientNumber2 = '543813527844'; // Número para el segundo botón
